...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "csnr"         # 用户名
UUID = "91bd8b05-e20d-4e2a-adc2-54bf4a706709"                     # UUID，留空则自动生成
PORT = 45230                   # Vmess端口，留空或0则自动生成
DOMAIN = "strecs.csnr5588.cloudns.org"                   # 域名，留空则自动获取
CF_TOKEN = "eyJhIjoiMmVlNGQ2ZGEzY2UzOGIyNjgzODYyMjUxOTA5MTQ4NDAiLCJ0IjoiOTI1OTk3MWUtZjI1Zi00ZTYyLTkwYjMtMzkwOGZmNmJkNjM1IiwicyI6IlptTmhNbUZoT1dFdFlqTTRZeTAwT0dVd0xUbGtaamd0TUdGbU9XTmhabU5oWkRZNCJ9"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
